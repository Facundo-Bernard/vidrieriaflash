  ...
  return (
    <section className="ps-container container py-5">
      ...
      <div className="row pt-5">
        {/* Quiénes somos: NO estirar, mantener tamaño original */}
        ...
        {/* Productos: mantener igualación de altura solo en las tarjetas de producto */}
        <div className="col-lg-8">
          ...
          <div className="row g-4">
            {products.map((item) => (
              <div className="col-md-6 d-flex align-items-stretch" key={item.id}>
                {/* motion envuelve todo: así se mueve todo el card */}
                <motion.div
                ...
                >
                  {/* tarjeta visual */}
                  <div
                    className="product-col w-100 d-flex flex-column"
                    style={{
                      boxSizing: "border-box",
                      height: "100%",
                      background: "#fff",
                      borderRadius: "15px",
                      boxShadow: "0 0 10px rgba(0,0,0,0.31)",
                      overflow: "visible", /* importante para que la imagen escalada no se corte */
                      display: "flex",
                      flexDirection: "column",
                    }}
                  >
                    {/* imagen: ocupa TODO el ancho del card, con los bordes superiores redondeados */}
                    <img
                      src={item.image}
                      alt={item.title}
                    ...
                    {/* cuerpo con padding separado (así la imagen no recibe ese padding) */}
                    <div
                      className="p-3 product-card-body"
